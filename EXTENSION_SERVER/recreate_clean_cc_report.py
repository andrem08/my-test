#!/usr/bin/env python3
"""
Delete and recreate the corrupted VHSYS-cc_report-v1.json file
with a corrected, clean version
"""
...
# Backup the old file
old_file = 'n8n_diagrams/VHSYS-cc_report-v1.json'
backup_file = 'n8n_diagrams/VHSYS-cc_report-v1.json.bak'
...
with open(old_file, 'w', encoding='utf-8') as f:
    json.dump(cc_report_data, f, indent=2, ensure_ascii=False)

print(f"✓ Created new file: {old_file}")
